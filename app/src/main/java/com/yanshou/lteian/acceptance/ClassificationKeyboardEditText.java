...
public class ClassificationKeyboardEditText extends EditText implements KeyboardView.OnKeyboardActionListener, View.OnClickListener {
    private PopupWindow mKeyboardWindow;
    private KeyboardView mKeyboardView;
    private Keyboard mKeyboard;
    private View mDecorView;

    public ClassificationKeyboardEditText(Context context) {
        this(context,null);
    }

    public ClassificationKeyboardEditText(Context context, AttributeSet attrs) {
        this(context,attrs, 0);
    }

    public ClassificationKeyboardEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initKeyboardView(Context context, AttributeSet attrs) {
        ...
        //关闭键盘按键预览效果，如果按键过小可能比较适用
        mKeyboardView.setPreviewEnabled(false);
        //设置按键事件
        mKeyboardView.setOnKeyboardActionListener(this);
        //将keyboardview放入popuwindow方便显示以及位置调整
