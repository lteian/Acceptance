package com.yanshou.lteian.classificationkeyboardview;
...
/**
 * 描述：自定义键盘
 * Create by lteian on 2018/07/19
 */

public class ClassificationKeyboardViewEditText extends android.support.v7.widget.AppCompatEditText implements KeyboardView.OnKeyboardActionListener, View.OnClickListener {
    private Keyboard mKeyboard;
    private KeyboardView mKeyboardView;
    private PopupWindow mKeyboardWindow;
    private View mDecorView;

    public ClassificationKeyboardViewEditText(Context context) {
        this(context, null);
    }

    public ClassificationKeyboardViewEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassificationKeyboardViewEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initKeyboardView(Context context, AttributeSet attrs) {
        TypedArray array;
//        array = context.obtainStyledAttributes(attrs, R.styleable.Keyboard);
...
//        int xmlId = array.getResourceId(R.styleable.Keyboard_xml, 0);
        mKeyboard = new Keyboard(context, R.xml.classification_keyboard);
